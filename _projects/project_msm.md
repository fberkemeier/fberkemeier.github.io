...
layout: distillpage
title: MSM
description: Multi-layer Signalling Model for Notch-Delta dynamics in 3D epithelia.
...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/research/3Dcells.gif" title="MSM" class="img-fluid rounded z-depth-1" %}
        <div class="caption" style="text-align: center; font-style: italic; margin-top: 10px;">
            MSM connects layered epithelial topology to Notch-Delta patterning.
        </div>
    </div>
</div>

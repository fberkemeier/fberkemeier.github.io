...
I completed a bachelor’s in Mathematics (IST, Lisbon) and an MSc in Functional Analysis under Prof. Diogo A. Gomes (KAUST, KSA). Motivated by the fascinating applications of mathematics and computation in the field of cellular and molecular biology, I decided to pursue a PhD in applied mathematics in biology at UCL under the guidance of Prof. Karen M. Page. My dissertation focused on the mathematical modelling of the Notch-Delta signalling pathway in various epithelial tissues.
